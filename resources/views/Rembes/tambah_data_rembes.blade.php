<div class="modal fade" id="rembesTambah" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <div class="card" id="tambah_akun">
            <div class="card-body">
              ...
              <!-- Vertical Form -->
              <form class="row g-3" action="/rembes-create" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="col-12">
                        <label  class="form-label">Nominal</label>
                         <input type="text" name="nominal" id="nominal_hutang" class="form-control @error('nominal') is-invalid @enderror">
                        @error('nominal')
                            <div id="validationServerUsernameFeedback" class="invalid-feedback">
                         {{ $message }}
                            </div>
