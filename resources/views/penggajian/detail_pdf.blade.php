...
<body>
    ...
    <h1>Slip Gaji</h1>
        ...
        <div class="card-header">
            Nama Karyawan: {{ $karyawan->nama_karyawan }} <br>
            No Rekening: {{ $karyawan->no_rekening }}<br>
        </div>
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="left"></td>
                            <td class="right">{{ $karyawan->nominal_hutang }}</td>
                        </tr>
                        <tr>
                            <td class="center">3</td>
                            <td class="left strong">Rembes</td>
                            <td class="left"></td>
                            <td class="right">{{ $karyawan->nominal_rembes }}</td>
                        </tr>
                        <tr>
                            <td class="center">4</td>
                            <td class="left strong">Transport</td>
                            <td class="left"></td>
                            <td class="right">{{ $karyawan->nominal_transport }}</td>
                        </tr>
                    </tbody>
                </table>
            </div>
                    ...
                    <table class="table table-clear">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="right"><strong>Rp. {{ number_format($sub_total - $karyawan->nominal_hutang) }}</strong></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
